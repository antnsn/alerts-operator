...
KIND_CLUSTER ?= alerts-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name alerts-operator-builder
	$(CONTAINER_TOOL) buildx use alerts-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm alerts-operator-builder
	rm Dockerfile.cross
