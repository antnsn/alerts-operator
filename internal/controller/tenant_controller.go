...
// +kubebuilder:rbac:groups=observability.antnsn.dev,resources=tenants,verbs=get;list;watch;create;update;patch;delete
...
func (r *TenantReconciler) Reconcile(ctx context.Context, _ ctrl.Request) (ctrl.Result, error) {
